...
<img src="/aaa_readme_00010_.gif" width="250" /> 

There are multiple technology available. 

[AnimateDiff: Animate Your Personalized Text-to-Image Diffusion Models without Specific Tuning](https://arxiv.org/abs/2307.04725)

Official implementation of AnimateDiff: [Repo](animatediff.github.io/)

To get started, there are several tutorial videos: 

* Command line app: [AnimateDiff-CLI](https://youtu.be/27M3xFZptmU) 

* Google Colab notebook run on cloud: [Colab notebook](https://youtu.be/hTWU3JRB-N0) (requries Google account to run)

* Animatediff with prompt travel and controlnet: [enchanced Animatediff](https://youtu.be/PkAVpvgeRyA)
